...
public class Solution implements Serializable, AutoCloseable {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        Solution s = new Solution("c:/JavaIDEA/res.txt");
        System.out.println("s: " + s.stream.getChannel());
        s.writeObject("lalka");
        oos.writeObject(s);

        ObjectInputStream ois = new ObjectInputStream(new FileInputStream("c:/JavaIDEA/try.txt"));
        Solution f = (Solution) ois.readObject();
        System.out.println("f: " + f.stream.getChannel());
        f.stream.write(110);
    }
}
