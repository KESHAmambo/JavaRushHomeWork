...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(loadedObject.staticString + ";" + loadedObject.i + ";" + loadedObject.j);//check here that classWithStatic object equals to loadedObject object - проверьте тут, что classWithStatic и loadedObject равны
