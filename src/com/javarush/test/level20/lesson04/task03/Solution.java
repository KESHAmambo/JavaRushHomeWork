...
public class Solution implements Serializable {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("c:/JavaIDEA/try.txt"));//"singleton.tmp"
        ...
        ObjectInputStream ois2 = new ObjectInputStream(new FileInputStream("c:/JavaIDEA/try.txt"));
