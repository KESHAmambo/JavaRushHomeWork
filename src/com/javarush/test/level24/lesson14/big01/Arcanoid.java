...
public class Arcanoid
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        game.getBricks().add(new Brick(13, 5));
        game.getBricks().add(new Brick(17, 3));
        game.getBricks().add(new Brick(3, 5));
        game.getBricks().add(new Brick(7, 7));
        game.getBricks().add(new Brick(13, 7));
        game.getBricks().add(new Brick(17, 5));
        game.getBricks().add(new Brick(10, 5));
