    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                Double change1 = stock1.containsKey("change") ? ((double) stock1.get("change")) : 0;
                Double change2 = stock2.containsKey("change") ? ((double) stock2.get("change")) : 0;
                if(change1 == 0) {
                    double open = (double) stock1.get("open");
                    double last = (double) stock1.get("last");
                    change1 = last - open;
                }
                if(change2 == 0) {
                    double open = (double) stock2.get("open");
                    double last = (double) stock2.get("last");
                    change2 = last - open;
                }
