package com.javarush.test.level16.lesson13.bonus03Handler;
...
public class Solution {
    ...
    public static class TestedThread extends Thread {
        public TestedThread(UncaughtExceptionHandler handler) {
            ...
            /*
            Можно заменить строку выше строкой:
            setDefaultUncaughtException(handler);
            Или данное решение: первая строка в методе run()
             */
            start();
        }
